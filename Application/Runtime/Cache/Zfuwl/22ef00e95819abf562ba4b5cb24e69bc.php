...
<div class="admin-main">
    <fieldset class="layui-elem-field">
        <div class="test-table-reload-btn" style="margin-top: 10px;margin-left:15px;">
            <form action="<?php echo U('Excel/exportChangeLog');?>" class='layui-form' id="search-form2">
                <div class="layui-inline" style='width:120px;'>
                    <input type="text" name="account" placeholder="转出会员账号" class="layui-input" />
                </div>
                <div class="layui-inline" style='width:120px;'>
                    <input type="text" name="to_account" placeholder="转入会员账号" class="layui-input" />
                </div>
                <div class="layui-inline">
                    <input type="text" name="note" placeholder="关键字" class="layui-input" />
                </div>
                <div class="layui-inline" style='width:120px;'>
                ...
                <div class="layui-inline">
                    <input type="text" name="time" placeholder="开始日" id="time" class="layui-input"/>
                </div>
                ...
                <button type="button" class="clearCache layui-btn layui-btn-danger" onclick="emptyEp();">清空转账记录</button>
...
<script>
    ...
    function ajax_get_table(tab, page){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo U('Change/changeLog');?>?p=" + page,
            data: $('#' + tab).serialize(),
    ...
    function emptyEp(){
        layer.confirm("是否确认清空数据，执行之后将不能撤销", {title:'温馨提示', icon:3}, function(){
            ...
            var url = "<?php echo U('Change/emptyChangeLog');?>";
