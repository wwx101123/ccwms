    ...
    <div class="admin-main">
        <fieldset class="layui-elem-field">
            <div class="test-table-reload-btn" style="margin-top: 10px;margin-left:15px;">
                <form action="<?php echo U('Excel/exportLelvllog');?>" class='layui-form' id="search-form2">
                    ...
                    <div class="layui-inline" style='width:100px;'>
                        <select name="statu">
                            ...
                            <?php if(is_array($upgradeStatu)): foreach($upgradeStatu as $k=>$v): ?><option value="<?php echo ($k); ?>"><?php echo ($v); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                    <div class="layui-inline">
                    ...
                    <button type="button" class="clearCache layui-btn  layui-btn-danger" onclick="emptyEp();"><i class="layui-icon">&#xe60b;</i> 清空申请日志</button>
                </form>
            </div>
...
<script type="text/javascript" src="/Public/js/zfuwlAjax.js"></script>
    ...
    <script>
        ...
        function ajax_get_table(tab, page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo U('Level/upgradeLog');?>?p=" + page,
                data: $('#' + tab).serialize(),
        ...
        function emptyEp(){
            layer.confirm("是否确认清空数据，执行之后将不能撤销", {title:'温馨提示', icon:3}, function(){
                ...
                var url = "<?php echo U('Level/emptyLevelLog');?>";
