    ...
    <fieldset class="layui-elem-field">
        <div class="test-table-reload-btn" style="margin-top: 10px;margin-left:15px;">
            <form action="<?php echo U('Excel/exportMoneyLog');?>" class='layui-form' id="search-form2">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="to_account" placeholder="相关会员账号" class="layui-input" />
                </div>
                <div class="layui-input-inline">
                ...
                <div class="layui-inline" style='width:120px;'>
                    <select name="is_type">
                        ...
                        <?php if(is_array($moneyLogType)): foreach($moneyLogType as $k=>$v): ?><option value="<?php echo ($k); ?>"><?php echo ($v); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
                <div class="layui-inline" style='width:120px;'>
                ...
                <button type="button" class="clearCache layui-btn  layui-btn-danger" onclick="emptyEp();">清空钱包明细</button>
            </form>
        </div>
...
<script>
    ...
    function ajax_get_table(tab, page){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo U('Money/moneyLog');?>?p=" + page,
            data: $('#' + tab).serialize(),
    ...
    function emptyEp(){
        layer.confirm("是否确认清空数据，执行之后将不能撤销", {title:'温馨提示', icon:3}, function(){
            ...
            var url = "<?php echo U('Money/emptyMoneyLog');?>";
