    ...
    <fieldset class="layui-elem-field">
        <div class="test-table-reload-btn" style="margin-top: 10px;margin-left:15px;">
            <form id="search-form2">
                <!-- <div class="layui-inline"><div class="layui-input-inline"><input type="text" name="name_cn" placeholder="税务名称" class="layui-input" /></div></div> -->
                <input type="hidden" name="order_by" value="tax_id">
                ...
                <!--<a href="<?php echo U('Bonus/addBonusTax');?>"><button type="button" class="layui-btn layui-btn-normal" style="float:right;"><i class="layui-icon">&#xe61f;</i> 新增扣税项</button></a>-->
...
<script>
    ...
    function ajax_get_table(tab, page){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo U('Bonus/taxIndex');?>?p=" + page,
            data: $('#' + tab).serialize(),
