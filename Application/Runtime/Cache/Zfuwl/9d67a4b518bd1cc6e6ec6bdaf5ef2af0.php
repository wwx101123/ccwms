    ...
    <fieldset class="layui-elem-field">
        <div class="test-table-reload-btn" style="margin-top: 10px;margin-left:15px;">
            <form action="<?php echo U('Excel/exportUserDay');?>" id="search-form2">
                ...
                <button type="button" class="clearCache layui-btn layui-btn-danger" onclick="emptyEp();">清空收支统计</button>
...
<script>
    ...
    function ajax_get_table(tab, page){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo U('Money/userDay');?>?p=" + page,
            data: $('#' + tab).serialize(),
    ...
    function emptyEp(){
        layer.confirm("是否确认清空数据，执行之后将不能撤销", {title:'温馨提示', icon:3}, function(){
            ...
            var url = "<?php echo U('Money/emptyUserDay');?>";
