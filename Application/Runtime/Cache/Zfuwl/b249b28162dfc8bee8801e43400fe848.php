    ...
    <div class="admin-main">
        <fieldset class="layui-elem-field">
            <div class="test-table-reload-btn" style="margin-top: 10px;margin-left:15px;">
                <form action="<?php echo U('Excel/exportUsersLockLog');?>" class='layui-form' id="search-form2">
...
<script type="text/javascript" src="/Public/js/zfuwlAjax.js"></script>
    ...
    <script>
        ...
        function ajax_get_table(tab, page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo U('User/locklog');?>?p=" + page,
                data: $('#' + tab).serialize(),
        ...
        function emptyUserLockLog(){
            layer.confirm("是否确认清空数据，执行之后将不能撤销", {title:'温馨提示', icon:3}, function(){
                ...
                var url = "<?php echo U('User/emptylockUserlog');?>";
